...
- Read the following article [Jason McCreary on writing clean code](https://dev.to/gonedark/writing-clean-code)
...
- Rewrite the file in a way that would improve readability for _you_.
...
- Work in small steps. Write these as separate [to-do's](https://dev.to/razbakov/todo-in-code-b) if you like. Test after every step and use small commits when you're sure everything still works.
